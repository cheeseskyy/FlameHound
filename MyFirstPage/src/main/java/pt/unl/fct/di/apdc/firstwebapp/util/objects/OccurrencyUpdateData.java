...
public class OccurrencyUpdateData {
	...
	public OccurrencyUpdateData() {
		
	}


	public OccurrencyUpdateData(String title, String description, String user, String location, String type, List<String> mediaURI) {
		this.title = title;
	...
	public OccurrencyUpdateData(String title, String description, String user, String location, String type, List<String> mediaURI, String flag) {
		this.title = title;
		this.description = description;
		this.user = user;
		this.location = location;
